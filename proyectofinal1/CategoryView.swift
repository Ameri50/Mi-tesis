...
struct CategoryView: View {
    ...
    private static func buildCategories(from allProducts: [SeedProduct]) -> [CategoryModel] {
        let categoryNames = ["iPad", "iPhone", "Mac", "Apple Watch", "AirPods", "TV y Casa", "Accesorios", "Repuestos"]
...
struct CategoryCardView: View {
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 14) {
            SafeImage(
                ...
                systemName: getSystemName(category.title),
                size: 75,
    ...
    private func getSystemName(_ category: String) -> String? {
        switch category {
        case "Repuestos":
