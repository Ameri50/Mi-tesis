...
class GeminiManager: ObservableObject {
    ...
    private var systemPrompt: String {
        ...
        con una persona, llamar, o si tú mismo ofreces una vía alterna de contacto):
        ...
        Cuando el cliente pida una recomendación de compra, identifica o pregunta brevemente
        para qué lo va a usar, y adapta la sugerencia a un perfil típico:
        ...
        - Diagnóstico básico según los síntomas que describa el cliente.
        ...
        - Comparaciones entre modelos del catálogo.
