        ...
        ZStack {
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    Button(action: {
                        // Aquí puedes abrir WhatsApp, email, o un sheet de contacto
                        if let url = URL(string: "https://wa.me/51999999999?text=Hola, me interesa el servicio de reparación: \(part.name)") {
